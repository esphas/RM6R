...
function EspLibraryFloor(id) {
  floors = ['2648222', '2648223', '2648224', '2648225', '2648226', '2648227'];
  url = 'https://api.github.com/repos/esphas/RM6R/contents/library/content_' + id + '.yml';
  id = 'postmessage_' + floors[id - 2];
  ...
  function generate(yfile) {
    ...
    document.getElementById(id).innerHTML = parseFloor(lib);
  }
